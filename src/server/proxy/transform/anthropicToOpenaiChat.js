 ...
 */
export function anthropicToOpenaiChat(body) {
    const messages = [];
...
function convertMessage(msg, output) {
...
function convertUserMessage(blocks, output) {
...
function convertAssistantMessage(blocks, output) {
    let textContent = '';
    const toolCalls = [];
    for (const block of blocks) {
        if (block.type === 'text') {
