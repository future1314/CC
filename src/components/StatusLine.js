...
function StatusLineInner({ messagesRef, lastAssistantMessageId, vimMode }) {
    ...
    return _jsx(Box, { paddingX: paddingX, gap: 2, children: statusLineText ? _jsx(Text, { dimColor: true, wrap: "truncate", children: _jsx(Ansi, { children: statusLineText }) }) : isFullscreenEnvEnabled() ? _jsx(Text, { children: " " }) : null });
}
