        ...
        case "list":
            {
                ...
                if ($[18] !== agentMcpServers || $[19] !== onComplete || $[20] !== servers || $[21] !== viewState.defaultTab) {
                    t11 = _jsx(MCPListPanel, { servers: servers, agentServers: agentMcpServers, onSelectServer: t9, onSelectAgentServer: t10, onComplete: onComplete, defaultTab: viewState.defaultTab });
                    $[18] = agentMcpServers;
                    $[19] = onComplete;
                    $[20] = servers;
